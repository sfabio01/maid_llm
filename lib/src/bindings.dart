...
class maid_llm {
  ...
  ffi.Pointer<llama_sampler> llama_sampler_init_tail_free(
    double z,
    int min_keep,
  ) {
    return _llama_sampler_init_tail_free(
      z,
      min_keep,
    );
  }

  late final _llama_sampler_init_tail_freePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<llama_sampler> Function(
              ffi.Float, ffi.Size)>>('llama_sampler_init_tail_free');
  late final _llama_sampler_init_tail_free = _llama_sampler_init_tail_freePtr
      .asFunction<ffi.Pointer<llama_sampler> Function(double, int)>();
  ...
  void llama_perf_dump_yaml(
    ffi.Pointer<FILE> stream,
    ffi.Pointer<llama_context> ctx,
  ) {
    return _llama_perf_dump_yaml(
      stream,
      ctx,
    );
  }

  late final _llama_perf_dump_yamlPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<FILE>,
              ffi.Pointer<llama_context>)>>('llama_perf_dump_yaml');
  late final _llama_perf_dump_yaml = _llama_perf_dump_yamlPtr.asFunction<
